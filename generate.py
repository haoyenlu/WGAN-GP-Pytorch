...
if __name__ == '__main__':
    ...
    # train model
    wgan_gp = WGAN_GP(g_channel=256,batch_size=batch_size,max_iters=args.max_iter,G_checkpoint=args.G_ckpt,D_checkpoint=args.D_ckpt,use_sm=args.use_sm)
    wgan_gp.train(dataloader,G_save_path="./models/netG",D_save_path="./models/netD")
